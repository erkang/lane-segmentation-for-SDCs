...
# @Last Modified time: 2018-06-14 04:35:51
...
### basic python modules end

### modules for DL operations
import numpy as np
import tensorflow as tf
### end


# [START Wrapper function for each test.]
def test_safe(func):
	"""
	Isolate tests
	"""
...
# [START function to assert tensor shape]
...
# [START Function to test the laod vgg function]
@test_safe
...
# [START Function to test the layers function.]
@test_safe
...
# [START Function to test the optimization function]
@test_safe
...
# [START Function to test the train neural network function.]
@test_safe
...
# [START Function to test the status of the Kitti dataset function]
@test_safe
